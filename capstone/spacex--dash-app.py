...
for _, row in spacex_df.iterrows():
    new_site = {'label':row['Launch Site'], 'value': row['Launch Site']}
    if new_site not in options:
        options.append(new_site)
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(spacex_df[spacex_df['Launch Site'] == entered_site]['class'], 
        names='class', 
        title=entered_site)
        return fig
